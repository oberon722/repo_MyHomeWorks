...
# 2. Открыть файл, в который вы будете копировать данные (если его нет, создать новый).
...
# _____________________________________________________________________________
# ПРИМЕЧАНИЯ
# Этот код открывает исходный файл для чтения, читает все строки в память,
# выбирает нужную строку и записывает её в целевой файл. Пользователь вводит номер
# строки, которую хочет скопировать из исходного файла.
# _____________________________________________________________________________
# _____________________________________________________________________________
